    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="relative z-10 container mx-auto px-6 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up">
              <Link to="/login">
                <Button size="lg" className="text-lg px-8 shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all">
                  Começar Agora
      ...
      <section className="py-20 bg-cosmic-surface/30">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 bg-gradient-to-r from-primary to-cosmic-accent bg-clip-text text-transparent">
            Recursos Poderosos
          </h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-card border border-border/50 rounded-lg p-6 hover:border-primary/50 transition-all hover:shadow-lg hover:shadow-primary/10">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center space-y-6 bg-gradient-to-br from-primary/10 via-cosmic-glow/10 to-cosmic-accent/10 rounded-2xl p-12 border border-primary/20">
            <h2 className="text-4xl font-bold">Pronto para Decolar?</h2>
